...
DROP TABLE IF EXISTS `dish_comments`;
...
LOCK TABLES `dish_comments` WRITE;
/*!40000 ALTER TABLE `dish_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `dish_comments` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-09-16 13:40:55
